...
<html lang="pt-br">
   <head>
      ...
      <title>view mine</title>
    <link rel="stylesheet" type="text/css" href="../css/viewMine.css"/>
        ...
        />
               ...
               <div class="menu">
                  <ul>
                     ...
                     <li><a href="#"></a></li>
                     <li><a href="#"></a></li>
                     <li><a href="add.php">Add new picture</a></li>
                     <li><a href="#"></a></li>
	  ...
	  <tbody>
	   <div class = "container mt-2" > 
				...
				$con=mysqli_connect("localhost","root","","bloom");
					...
					$sql="SELECT * FROM `gift` WHERE `status`='1' or `status`='0' ;";
	            ...
	            <div class="image">
				  <a href="<?php echo $row['imagePath'];?>"><img src="<?php echo $row['imagePath'];?>" width="195" height="192" alt=""/> </a>
					...
					<a href="edit.php?id=<?php echo $row['giftID']; ?>">Edit | <a href="delete.php?id=<?php echo $row['giftID']; ?>">Delete</a>
				   </div>
				   </div>
				</div>
